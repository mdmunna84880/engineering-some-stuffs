...
import { useAddTaskMutation, useDeleteTaskMutation, useGetTaskQuery, useUpdateTaskMutation } from "./apiSlice";

export default function Home() {
  const [newTask, setNewTask] = useState("");

  const {isError, data: tasksList, isLoading, error} = useGetTaskQuery();
